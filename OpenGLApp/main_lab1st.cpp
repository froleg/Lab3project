...
void CreateTriangle()
{
	...
	GLfloat r = 0.6;
	GLfloat xr_base = r*glm::cos(glm::radians(30.0));
	GLfloat yr_base = r*glm::sin(glm::radians(30.0));
	GLfloat x_base = glm::cos(glm::radians(30.0));
	GLfloat y_base = glm::sin(glm::radians(30.0));
	GLfloat vertices[] = {
		0.0f, 0.0f, 1.0f,
		-x_base, 0.0f, -y_base,
		x_base,  0.0f, -y_base,
		...
		x_base,  1.5f, -y_base,
		0.0f, 0.0f, r,
		-xr_base, 0.0f, -yr_base,
		xr_base,  0.0f, -yr_base,
		0.0f,  1.5f, r,
		-xr_base,  1.5f, -yr_base,
		xr_base,  1.5f, -yr_base,
	};
